%% Fresnel Propagation and Maximum Intensity Function for CPU/GPU.
% Version 5.0
% The Fresnel appoximation describes how the image from an object gets
% propagated in real space.
% This function produces the maximum intensity (per pixel) from a hologram
...
% function [Imax, zmap] = imax(Ein,lambda,Z,ps,zpad)
% inputs:
...
% outputs:Imax - find maximum intensity of each pixel through focus
%         zmap - map z-coordinate to each maximum intesity pixel
%
% Daniel Shuldman, UC Berkeley, eliasds@gmail.com


function [Imax, zmap] = imax(Ein,lambda,Z,ps,varargin)
